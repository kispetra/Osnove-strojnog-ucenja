...
#1
KNN_model = KNeighborsClassifier( n_neighbors =5) #K=1, K=100
...
print("Tocnost train KNN: " + "{:0.3f}".format((accuracy_score(y_train, y_train_p_SVM))))
print("Tocnost test KNN: " + "{:0.3f}".format((accuracy_score(y_test, y_test_p_SVM))))